...
const instructions = magpieViews.view_generator("instructions", {
  ...
  text: `In this experiment you will be shown simple questions.
  Your task is to give an answer by pressing one of the two buttons.
  <br />
  <br />`,
...
const forced_choice = magpieViews.view_generator("forced_choice", {
